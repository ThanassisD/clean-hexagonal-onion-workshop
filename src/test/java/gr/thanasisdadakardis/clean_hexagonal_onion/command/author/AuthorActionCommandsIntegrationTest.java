...
import gr.thanasisdadakardis.clean_hexagonal_onion.data.book.BookRepository;
...
class AuthorActionCommandsIntegrationTest {
    ...
    void registerAndGet() throws Exception {
        //given
        var registerAuthorPayloadJson = objectMapper.writeValueAsString(new CreateAuthorModel("firstName", "lastName"));
